...
| Verifiable Claims | [KILT](https://github.com/KILTprotocol/kilt-node) :green_circle:, [Dock](https://github.com/docknetwork/dock-substrate) :yellow_circle:, [Fennel Protocol](https://github.com/fennelLabs/Fennel-Protocol) :yellow_circle:
| Supply chain| | | 
